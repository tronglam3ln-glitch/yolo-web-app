...
// .replace(/\/+$/, '') để loại bỏ dấu "/" thừa ở cuối, tránh lỗi double-slash
// (vd: "https://host.com//api/..." khiến FastAPI trả về 404 Not Found).
const RAW_API_BASE_URL = import.meta.env.VITE_API_URL || "https://yolo-web-app-hrgd.onrender.com";
